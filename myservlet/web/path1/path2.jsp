...
<body>
    ...
    <a href="http://127.0.0.1:8080/myservlet/path1/insert.jsp">同一个应用同一个目录下的文件：insert.jsp</a><br>
    <a href="http://127.0.0.1:8080/myservlet/path1/sub/show.jsp">同一个应用同级目录下的文件：sub/show.jsp</a><br>
    <a href="http://127.0.0.1:8080/myservlet/path2/update.jsp">同一个应用其他目录下的文件1：path2/update.jsp</a><br>
    <a href="http://127.0.0.1:8080/myservlet/index.jsp">同一个应用其他目录下的文件2：index.jsp</a><br>
    <a href="http://127.0.0.1:8080/myservlet/servlet/FirstServlet">同一个应用的servlet FirstServlet</a><br>
    <a href="http://127.0.0.1:8080/jsp01/cart/cart.html">同一个服务器不同应用cart.html</a><br>
