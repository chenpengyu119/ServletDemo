...
public class DbUtils {
    ...
    private static final String URL1 = "jdbc:mysql://127.0.0.1:3306/employeemanage?useUnicode=true&characterEncoding=utf8";
    ...
    public static <T>  List<T> queryGeneral(String sql,Class<T> clazz){
        ...
        try {
          ...
          /*  Field[] fieldSuper = clazz.getSuperclass().getDeclaredFields();
            Field[] fieldAll = new Field[fields.length+fieldSuper.length];
            System.arraycopy(fields, 0, fieldAll, 0, fields.length);
            System.arraycopy(fieldSuper, 0, fieldAll, fields.length, fieldSuper.length);
            fields = fieldAll;
*/
            while (rs.next()) {
                // 给该类的所有属性赋值
